...
class local_MSE:
    ...
    def loss(self, y_true, y_pred, label):
        return torch.mean((y_true[label!=0] - y_pred[label!=0]) ** 2)

'''
Code from: https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/main/TransMorph/losses.py#L570
'''
